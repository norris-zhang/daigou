...
<%request.setAttribute("kw", request.getParameter("kw")); %>
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<form class="form-inline mt-2 mt-md-0" action="${ctx}/product/search" method="post">
				<input class="form-control mr-sm-2" type="text" name="keyword" value="${kw}" placeholder="爱他美" aria-label="Search" autocomplete="off"/>
